...
/* renamed from: com.predictezy.fp.PremierLeagueStandings */
public class PremierLeagueStandings extends AppCompatActivity {
    Button backButton;
    Toast calculate;
    Toast connect;
    int count = 0;
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.premier_league_standings);
        ...
        adView.setAdUnitId("ca-app-pub-2924639732611391/9016253895");
        ...
        new Thread() {
            public void run() {
                String str="null";
                PremierLeagueStandings PremierLeagueStandings = PremierLeagueStandings.this;
                PremierLeagueStandings.db = PremierLeagueStandings.getItems();
                while (String.valueOf(PremierLeagueStandings.db).equals("null") && PremierLeagueStandings.count<10) {
                    if (String.valueOf(PremierLeagueStandings.this.db).equals(str) && PremierLeagueStandings.this.count < 10) {
                        try {
                            sleep(1000);
                            PremierLeagueStandings.this.count++;
                            System.out.println(PremierLeagueStandings.this.count);
                        } catch (InterruptedException e) {
                            e.printStackTrace();
                        }
                    }
                }
                if (String.valueOf(PremierLeagueStandings.this.db).equals(str)) {
                    PremierLeagueStandings.this.runOnUiThread(new Runnable() {
                        public void run() {
                            PremierLeagueStandings.this.error.show();
                            PremierLeagueStandings.this.startActivity(new Intent(PremierLeagueStandings.this, HomePage.class));
                        }
                    });
                } else {
                    PremierLeagueStandings.this.runOnUiThread(new Runnable() {
                        public void run() {
                            PremierLeagueStandings.this.Visibility();
                        }
                    });
                }
            }
    ...
    public ArrayList<HashMap<String, String>> getItems() {
        StringRequest stringRequest = new StringRequest(0, "https://script.google.com/macros/s/AKfycbytBJ9stMoyh9kGaYpRfhaCXUpAJpkeI1N1P0mNTqa-zSl4K6hw/exec?action=getItems", new Listener<String>() {
            public void onResponse(String str) {
                PremierLeagueStandings PremierLeagueStandings = PremierLeagueStandings.this;
                PremierLeagueStandings.db = PremierLeagueStandings.parseItems(str);
            }
        }, new ErrorListener() {
