...
/* renamed from: com.predictezy.fp.PremierLeagueMatches */
public class PremierLeagueMatches extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.premier_league_matches);
        ...
        adView.setAdUnitId("ca-app-pub-2924639732611391/8086315608");
        ...
        ArrayAdapter createFromResource = ArrayAdapter.createFromResource(this, R.array.PLTeams, R.layout.spinner_text);
        ...
        new Thread() {
            public void run() {
                String str="null";
                PremierLeagueMatches PremierLeagueMatches = PremierLeagueMatches.this;
                PremierLeagueMatches.db = PremierLeagueMatches.getItems();
                while (String.valueOf(PremierLeagueMatches.db).equals("null") && PremierLeagueMatches.count<10) {
                    if (String.valueOf(PremierLeagueMatches.this.db).equals(str) || PremierLeagueMatches.this.count < 10) {
                        try {
                            sleep(1000);
                            PremierLeagueMatches.this.count++;
                            System.out.println(PremierLeagueMatches.this.count);
                        } catch (InterruptedException e) {
                            e.printStackTrace();
                        }
                    }
                }
                if (String.valueOf(PremierLeagueMatches.this.db).equals(str)) {
                    PremierLeagueMatches.this.runOnUiThread(new Runnable() {
                        public void run() {
                            PremierLeagueMatches.this.error.show();
                            PremierLeagueMatches.this.startActivity(new Intent(PremierLeagueMatches.this, HomePage.class));
                        }
                    });
                } else {
                    PremierLeagueMatches.this.runOnUiThread(new Runnable() {
                        public void run() {
                            PremierLeagueMatches.this.Visibility();
                        }
                    });
                }
            }
        ...
        this.buttonPredict.setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                PremierLeagueMatches PremierLeagueMatches = PremierLeagueMatches.this;
                PremierLeagueMatches.HomeInputTeam = PremierLeagueMatches.HomeTeam.getSelectedItem().toString();
                PremierLeagueMatches PremierLeagueMatches2 = PremierLeagueMatches.this;
                PremierLeagueMatches2.AwayInputTeam = PremierLeagueMatches2.AwayTeam.getSelectedItem().toString();
                String str = "";
                PremierLeagueMatches.this.homeTeamScore.setText(str);
                PremierLeagueMatches.this.awayTeamScore.setText(str);
                String str2 = "Invalid Teams Chosen";
                if (PremierLeagueMatches.this.HomeInputTeam.equals(PremierLeagueMatches.this.AwayInputTeam)) {
                    PremierLeagueMatches.this.predictions.setVisibility(View.INVISIBLE);
                    Toast.makeText(PremierLeagueMatches.this, str2, Toast.LENGTH_SHORT).show();
                    return;
                }
                String str3 = "Select A Team";
                if (PremierLeagueMatches.this.HomeInputTeam.equals(str3) || PremierLeagueMatches.this.AwayInputTeam.equals(str3)) {
                    Toast.makeText(PremierLeagueMatches.this, str2, Toast.LENGTH_SHORT).show();
                    PremierLeagueMatches.this.predictions.setVisibility(View.INVISIBLE);
                    return;
                }
                else {
                    PremierLeagueMatches.this.predictions.setVisibility(View.VISIBLE);
                    PremierLeagueMatches PremierLeagueMatches3 = PremierLeagueMatches.this;
                    PremierLeagueMatches3.startPredictions(PremierLeagueMatches3.HomeInputTeam, PremierLeagueMatches.this.AwayInputTeam);
                }
            }
        });
    ...
    public ArrayList<HashMap<String, String>> getItems() {
        StringRequest stringRequest = new StringRequest(0, "https://script.google.com/macros/s/AKfycbxJt3yeRk6vK03kGKrrzd110-8xwtjYghrv3vBwsE5JXSYDiFUF/exec?action=getItems", new Listener<String>() {
            public void onResponse(String str) {
                PremierLeagueMatches PremierLeagueMatches = PremierLeagueMatches.this;
                PremierLeagueMatches.db = PremierLeagueMatches.parseItems(str);
            }
        }, new ErrorListener() {
    ...
    private void calculateScore(String[] strArr, String[] strArr2, String[] strArr3) {
        ...
        String[] stringArray = getResources().getStringArray(R.array.PLTeams);
        String[] stringArray2 = getResources().getStringArray(R.array.PLTeamsShortHand);
