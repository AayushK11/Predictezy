...
/* renamed from: com.predictezy.fp.BundesligaMatches */
public class BundesligaMatches extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.bundesliga_matches);
        ...
        ArrayAdapter createFromResource = ArrayAdapter.createFromResource(this, R.array.BLTeams, R.layout.spinner_text);
        ...
        adView.setAdUnitId("ca-app-pub-2924639732611391/8676029461");
        ...
        new Thread() {
            public void run() {
                String str = "null";;
                BundesligaMatches BundesligaMatches = BundesligaMatches.this;
                BundesligaMatches.db = BundesligaMatches.getItems();
                while (String.valueOf(BundesligaMatches.db).equals("null") && BundesligaMatches.count<10) {
                    
                    if (String.valueOf(BundesligaMatches.this.db).equals(str) && BundesligaMatches.this.count < 10) {
                        try {
                            sleep(1000);
                            BundesligaMatches.this.count++;
                            System.out.println(BundesligaMatches.this.count);
                        } catch (InterruptedException e) {
                            e.printStackTrace();
                        }
                    }
                }
                if (String.valueOf(BundesligaMatches.this.db).equals(str)) {
                    BundesligaMatches.this.runOnUiThread(new Runnable() {
                        public void run() {
                            BundesligaMatches.this.error.show();
                            BundesligaMatches.this.startActivity(new Intent(BundesligaMatches.this, HomePage.class));
                        }
                    });
                } else {
                    BundesligaMatches.this.runOnUiThread(new Runnable() {
                        public void run() {
                            BundesligaMatches.this.Visibility();
                        }
                    });
                }
            }
        ...
        this.buttonPredict.setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                BundesligaMatches BundesligaMatches = BundesligaMatches.this;
                BundesligaMatches.HomeInputTeam = BundesligaMatches.HomeTeam.getSelectedItem().toString();
                BundesligaMatches BundesligaMatches2 = BundesligaMatches.this;
                BundesligaMatches2.AwayInputTeam = BundesligaMatches2.AwayTeam.getSelectedItem().toString();
                String str = "";
                BundesligaMatches.this.homeTeamScore.setText(str);
                BundesligaMatches.this.awayTeamScore.setText(str);
                String str2 = "Invalid Teams Chosen";
                if (BundesligaMatches.this.HomeInputTeam.equals(BundesligaMatches.this.AwayInputTeam)) {
                    BundesligaMatches.this.predictions.setVisibility(View.INVISIBLE);
                    Toast.makeText(BundesligaMatches.this, str2, Toast.LENGTH_SHORT).show();
                    return;
                }
                String str3 = "Select A Team";
                if (BundesligaMatches.this.HomeInputTeam.equals(str3) || BundesligaMatches.this.AwayInputTeam.equals(str3)) {
                    Toast.makeText(BundesligaMatches.this, str2, Toast.LENGTH_SHORT).show();
                    BundesligaMatches.this.predictions.setVisibility(View.INVISIBLE);
                    return;
                }
                else {
                    BundesligaMatches.this.predictions.setVisibility(View.VISIBLE);
                    BundesligaMatches BundesligaMatches3 = BundesligaMatches.this;
                    BundesligaMatches3.startPredictions(BundesligaMatches3.HomeInputTeam, BundesligaMatches.this.AwayInputTeam);
                }
            }
        });
    ...
    public ArrayList<HashMap<String, String>> getItems() {
        StringRequest stringRequest = new StringRequest(0, "https://script.google.com/macros/s/AKfycbwzO21tnuNfGQIVlAluZCZhFwW9ehZTZQKGacWaQqF42XlMWffH/exec?action=getItems", new Listener<String>() {
            public void onResponse(String str) {
                BundesligaMatches BundesligaMatches = BundesligaMatches.this;
                BundesligaMatches.db = BundesligaMatches.parseItems(str);
            }
        }, new ErrorListener() {
    ...
    private void calculateScore(String[] strArr, String[] strArr2, String[] strArr3) {
        ...
        String[] stringArray = getResources().getStringArray(R.array.BLTeams);
        String[] stringArray2 = getResources().getStringArray(R.array.BLTeamsShortHand);
