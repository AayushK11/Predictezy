...
/* renamed from: com.predictezy.fp.Ligue1Matches */
public class Ligue1Matches extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.ligue1_matches);
        ...
        ArrayAdapter createFromResource = ArrayAdapter.createFromResource(this, R.array.L1Teams, R.layout.spinner_text);
        ...
        adView.setAdUnitId("ca-app-pub-2924639732611391/9207825584");
        ...
        new Thread() {
            public void run() {
                String str = "null";;
                Ligue1Matches Ligue1Matches = Ligue1Matches.this;
                Ligue1Matches.db = Ligue1Matches.getItems();
                while (String.valueOf(Ligue1Matches.db).equals("null") && Ligue1Matches.count<10) {

                    if (String.valueOf(Ligue1Matches.this.db).equals(str) && Ligue1Matches.this.count < 10) {
                        try {
                            sleep(1000);
                            Ligue1Matches.this.count++;
                            System.out.println(Ligue1Matches.this.count);
                        } catch (InterruptedException e) {
                            e.printStackTrace();
                        }
                    }
                }
                if (String.valueOf(Ligue1Matches.this.db).equals(str)) {
                    Ligue1Matches.this.runOnUiThread(new Runnable() {
                        public void run() {
                            Ligue1Matches.this.error.show();
                            Ligue1Matches.this.startActivity(new Intent(Ligue1Matches.this, HomePage.class));
                        }
                    });
                } else {
                    Ligue1Matches.this.runOnUiThread(new Runnable() {
                        public void run() {
                            Ligue1Matches.this.Visibility();
                        }
                    });
                }
            }
        ...
        this.buttonPredict.setOnClickListener(new OnClickListener() {
            public void onClick(View view) {
                Ligue1Matches Ligue1Matches = Ligue1Matches.this;
                Ligue1Matches.HomeInputTeam = Ligue1Matches.HomeTeam.getSelectedItem().toString();
                Ligue1Matches Ligue1Matches2 = Ligue1Matches.this;
                Ligue1Matches2.AwayInputTeam = Ligue1Matches2.AwayTeam.getSelectedItem().toString();
                String str = "";
                Ligue1Matches.this.homeTeamScore.setText(str);
                Ligue1Matches.this.awayTeamScore.setText(str);
                String str2 = "Invalid Teams Chosen";
                if (Ligue1Matches.this.HomeInputTeam.equals(Ligue1Matches.this.AwayInputTeam)) {
                    Ligue1Matches.this.predictions.setVisibility(View.INVISIBLE);
                    Toast.makeText(Ligue1Matches.this, str2, Toast.LENGTH_SHORT).show();
                    return;
                }
                String str3 = "Select A Team";
                if (Ligue1Matches.this.HomeInputTeam.equals(str3) || Ligue1Matches.this.AwayInputTeam.equals(str3)) {
                    Toast.makeText(Ligue1Matches.this, str2, Toast.LENGTH_SHORT).show();
                    Ligue1Matches.this.predictions.setVisibility(View.INVISIBLE);
                    return;
                }
                else {
                    Ligue1Matches.this.predictions.setVisibility(View.VISIBLE);
                    Ligue1Matches Ligue1Matches3 = Ligue1Matches.this;
                    Ligue1Matches3.startPredictions(Ligue1Matches3.HomeInputTeam, Ligue1Matches.this.AwayInputTeam);
                }
            }
        });
    ...
    public ArrayList<HashMap<String, String>> getItems() {
        StringRequest stringRequest = new StringRequest(0, "https://script.google.com/macros/s/AKfycbyH7wr30QQjrtjUhUSfTDGbAg7VrqsY14rpv9En01ena63Aq2fU/exec?action=getItems", new Listener<String>() {
            public void onResponse(String str) {
                Ligue1Matches Ligue1Matches = Ligue1Matches.this;
                Ligue1Matches.db = Ligue1Matches.parseItems(str);
            }
        }, new ErrorListener() {
    ...
    private void calculateScore(String[] strArr, String[] strArr2, String[] strArr3) {
        ...
        String[] stringArray = getResources().getStringArray(R.array.L1Teams);
        String[] stringArray2 = getResources().getStringArray(R.array.L1TeamsShortHand);
