...
/* renamed from: com.predictezy.fp.Ligue1Standings */
public class Ligue1Standings extends AppCompatActivity {
    Button backButton;
    Toast calculate;
    Toast connect;
    int count = 0;
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.ligue1_standings);
        ...
        adView.setAdUnitId("ca-app-pub-2924639732611391/3572355521");
        ...
        new Thread() {
            public void run() {
                String str = "null";
                Ligue1Standings Ligue1Standings = Ligue1Standings.this;
                Ligue1Standings.db = Ligue1Standings.getItems();
                while (String.valueOf(Ligue1Standings.db).equals("null") && Ligue1Standings.count<10) {
                    
                    if (String.valueOf(Ligue1Standings.this.db).equals(str) && Ligue1Standings.this.count < 10) {
                        try {
                            sleep(1000);
                            Ligue1Standings.this.count++;
                            System.out.println(Ligue1Standings.this.count);
                        } catch (InterruptedException e) {
                            e.printStackTrace();
                        }
                    }
                }
                if (String.valueOf(Ligue1Standings.this.db).equals(str)) {
                    Ligue1Standings.this.runOnUiThread(new Runnable() {
                        public void run() {
                            Ligue1Standings.this.error.show();
                            Ligue1Standings.this.startActivity(new Intent(Ligue1Standings.this, HomePage.class));
                        }
                    });
                } else {
                    Ligue1Standings.this.runOnUiThread(new Runnable() {
                        public void run() {
                            Ligue1Standings.this.Visibility();
                        }
                    });
                }
            }
    ...
    public ArrayList<HashMap<String, String>> getItems() {
        StringRequest stringRequest = new StringRequest(0, "https://script.google.com/macros/s/AKfycbwDJ8uyE-QbAjAhmTcU131UzzFqXLkqJzgL1Jek05T7ie_weR4/exec?action=getItems", new Listener<String>() {
            public void onResponse(String str) {
                Ligue1Standings Ligue1Standings = Ligue1Standings.this;
                Ligue1Standings.db = Ligue1Standings.parseItems(str);
            }
        }, new ErrorListener() {
